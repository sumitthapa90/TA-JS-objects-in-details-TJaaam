...
console.log(user.sayHello.call(user2, "Hey")); // Hay Arya
console.log(user.sayHello.apply(user2, ["Hey"])); // Hey Arya
console.log(typeof user.sayHello.bind(user2)); // function  bind return a function reffrence
...
console.log(user3.sayHello()); // outside function
